...
5) `sls deploy`
6) Wait 10 minutes... The first deploy takes a long time because it creates a new RDS instance. [Why RDS? Read 2. of serverless.yml section](https://github.com/Ascendzor/aws-node-websockets#serverlessyml)
